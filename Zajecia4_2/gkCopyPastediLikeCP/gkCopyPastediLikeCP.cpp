// gkCopyPastediLikeCP.cpp : Defines the entry point for the console application.
//
...

{
	...
	GLboolean error = load_targa("grass_from_gardens.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku grass_from_gardens.tga");
