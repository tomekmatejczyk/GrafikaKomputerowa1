// gkCopyPastedFromJanuszGanczarski.[ctrl+c]+[ctrl+v] : Entry point must be always on point haha
//
...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("blonde_guy_white_skin_face_2.tga", width, height, format, type, pixels);
	...
	error = load_targa("blonde_guy_white_skin_face_2.tga", width, height, format, type, pixels);
